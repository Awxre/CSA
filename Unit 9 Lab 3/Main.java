...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Package p1 = new Package(5, "Air");
        Package p2 = new Package(10, "Truck");
        Package p3 = new Package(15, "Mail");
        InsuredPackage ip1 = new InsuredPackage(1, "Air");
        InsuredPackage ip2 = new InsuredPackage(25, "Truck");
        InsuredPackage ip3 = new InsuredPackage(15, "Mail");
